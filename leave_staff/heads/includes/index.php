...
<div class="main-container"  style="background-color: #DCD7C9;">
	<div class="pd-ltr-20">
		...
		<div class="row m-2 mb-4">
			...
			<?php
				...
				$departmenthead = $row['departmentName'];
			?>

			<?php
				$sql = "SELECT * FROM tblleaves WHERE leaveStatus=0 AND hrStatus=1 AND hodStatus=0 AND department='$departmenthead'";
				$query = mysqli_query($conn, $sql) or die(mysqli_error($conn));
				$count = mysqli_num_rows($query);
				$row = mysqli_fetch_array($query);
			?>
	...
	<div class="p-2 pt-3 pb-3 mb-3" style="background-color: #F0F0F0;">
		<!--@Leave Type-->
		<p class="h3 m-0 p-0 pl-3">My Leave</p>
						...
						<table class="table stripe hover nowrap">
							...
							<tbody>
								<tr>
									...
									$sql = "SELECT * from tblleaves where empID='$session_id' AND leaveStatus=1 order by leaveID desc limit 5";
										$query = mysqli_query($conn, $sql) or die(mysqli_error());
										while ($row = mysqli_fetch_array($query)) {
										  	$date = date('d-m-Y', strtotime($row['appliedDate']));
										  	$cnt=1;
						...
						<table class="table stripe hover nowrap">
							...
							<tbody>
								<tr>
									...
									$sql = "SELECT * from tblleaves where empID='$session_id' AND leaveStatus=0 order by leaveID desc limit 5";
										$query = mysqli_query($conn, $sql) or die(mysqli_error());
										while ($row = mysqli_fetch_array($query)) {
										  	$date = date('d-m-Y', strtotime($row['appliedDate']));
										  	$cnt=1;
						...
						<table class="table stripe hover nowrap">
							...
							<tbody>
								<tr>
									...
									$sql = "SELECT * from tblleaves where empID='$session_id' AND leaveStatus=2 order by leaveID desc limit 5";
										$query = mysqli_query($conn, $sql) or die(mysqli_error());
										while ($row = mysqli_fetch_array($query)) {
										  	$date = date('d-m-Y', strtotime($row['appliedDate']));
										  	$cnt=1;
						...
						<table class="table stripe hover nowrap">
							...
							<tbody>
								<tr>
									...
									$sql = "SELECT * from tblleaves where empID='$session_id' AND leaveStatus=4 order by leaveID desc limit 5";
										$query = mysqli_query($conn, $sql) or die(mysqli_error());
										while ($row = mysqli_fetch_array($query)) {
										  	$date = date('d-m-Y', strtotime($row['appliedDate']));
										  	$cnt=1;
