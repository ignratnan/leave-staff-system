				...
				<form method="post" action="">
					...
					<div class="form-group row pl-2">
						...
						<div class="col-md-3">
							...
							<!--@Approver Name-->
							<?php if($hr_stats==1){ ?>
							<label style="font-size:14px; margin-top: 0px" class=""><i>
									By: <?php echo $hrName; ?>
								</i></label>
							<?php } ?>
							<!--#Approver Name-->
					...
					<div class="form-group row pl-2">
							...
							<div class="col-md-3">
								...
								<!--@Approval Name-->
								<?php if($hod_stats==1 or $hod_stats==2){ ?>
								<label style="font-size:14px; margin-top: 0px" class=""><i>
									By: <?php echo $hodName; ?>
								</i></label>
								<?php } ?>
					...
					<div class="form-group row pl-2">
							...
							<div class="col-sm-12 col-md-10">
								<?php 
								if ($hodStatus==2){ ?>
								  	<input type="text" class="selectpicker form-control" data-style="btn-outline-primary" readonly style="color: gray; font-style: italic;"  value="<?php echo "Not Available"; ?>">
								  	<?php }else{ ?>
								<?php
								if ($result->gmRemark==""): ?>
								  <input type="text" class="selectpicker form-control" data-style="btn-outline-primary" readonly value="<?php echo "Waiting for Approval"; ?>">
					...
					<div class="form-group row pl-2">
							...
							<div class="col-md-3">
								...
								<!--@Approval Name-->
								<?php if($gm_stats==1 or $gm_stats==2){ ?>
								<label style="font-size:14px; margin-top: 0px" class=""><i>
									By: <?php echo $gmName; ?>
								</i></label>
								<?php } ?>
