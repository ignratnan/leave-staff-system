						...
						<div class="col-md-6 col-sm-12">
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item"><a href="my_leave.php">My Leave</a></li>
			...
			<div class="pd-20 card-box mb-0">
				...
				<form method="post" action="">
					...
					<div class="form-group row pl-2">
							...
							<div class="col-sm-12 col-md-10">
								...
								if ($leaveStatus==4){ ?>
									...
									<?php elseif ($hrRemark=="" AND $hrStatus==2): ?>
					...
					<div class="form-group row pl-2">
							...
							<label style="font-size:16px;" class="col-sm-12 col-md-3 col-form-label"><b></b></label>
							<label style="font-size:16px;" class="col-sm-12 col-md-1 col-form-label"><b>- Date</b></label>
							<div class="col-md-3">
				...
				?>
					...
					<div class="row">
						...
						<?php if ($hrStatus==0){ ?>
						<div class="col-md-2 pl-4 pt-1">
							<button class="btn btn-primary" id="takeAction" data-toggle="modal" data-target="#success-modal">Take&nbsp;Action</button>
						</div>
						<?php } ?>
						<!--#Button for HR-->
					...
					<form name="hrAction" method="post">
						...
						<div class="modal-dialog modal-dialog-centered" role="document">
							<div class="modal-content">
								<div class="modal-body text-center font-18">
									...
									<div class="form-group">
										<label></label>
										<textarea id="textarea1" name="description" class="form-control" placeholder="Description" length="300" maxlength="300"></textarea>
									</div>
								</div>
