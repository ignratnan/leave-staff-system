			...
			<div class="pd-20 card-box mb-0">
				...
				<form method="post" action="">
					...
					<div class="row">
						...
						<div class="col-md-10 col-sm-12">
							<input type="text" name="email" class="selectpicker form-control" data-style="btn-outline-primary" autocomplete="off" required="true" value="<?php echo $email; ?>">
						</div>
					</div>
					<hr class="m-0" style="border-width: 2px;">
					...
					<div class="row">
						<div class="col-md-12 col-sm-12 p-3 pl-4" style="text-align: center;">
							...
							<button class="btn btn-primary ml-4 mr-4" name="cancel" id="cancel"data-toggle="modal" style=" ">Cancel</button>
						</div>
					</div>
