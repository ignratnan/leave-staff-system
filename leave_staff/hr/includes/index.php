...
<div class="main-container"  style="background-color: #DCD7C9;">
	<div class="pd-ltr-20">
		...
		<div class="row m-2">
			...
			<?php
				$sql = "SELECT * FROM tblleaves WHERE leaveStatus=0 AND hrStatus=0";
		...
		<!--@Leave Type-->
		<ul class="nav nav-tabs customtab mt-3 mb-20" role="tablist">
			<li class="pl-3 pr-3 bg-secondary nav-item col-xl-3 col-lg-3 col-md-6 mb-20 p-1" style="text-align: center; border-radius: 0px;">
				<a class="nav-link active p-0" data-toggle="tab" href="#" role="tab"><h5 class=" h3 m-0 p-1">All Leave</h4></a>
			</li>
			<li class="pl-3 pr-3 bg-secondary nav-item col-xl-3 col-lg-3 col-md-6 mb-20 p-1" style="text-align: center; border-radius: 0px;">
