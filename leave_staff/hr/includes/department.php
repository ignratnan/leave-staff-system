	...
	<div class="pd-ltr-20">
		...
		<div class="">
				...
				<div class="col-lg-6 col-md-12 col-sm-12 p-1">
					<div class="card-box pt-10 height-100-p">
						<div class="">
							...
							<div id="<?php echo $departmentShortName; ?>" class="card-box height-100-p" style="display: none; background: none; font-family: tahoma;">
								<div class="pb-20" style="padding-left: 30px; padding-right: 30px;">
							...
							<div id="noDepartment" class="card-box height-100-p" style="display: none; background: none; font-family: tahoma;">
			...
			<div class="row p-2 pt-3 pb-3 mb-3" style="background-color: #F0F0F0;">
				...
				<div class="col-lg-12">
					<div class="card-box pt-10 height-100-p p-2">
						<form method="post">
								...
								<tr>
									...
									<td class="">
										<p style="width: 200px; text-align: center;">
											<input class="pl-1 pr-1" style="border-radius: 5px;" type="submit" name="add" value="Add" />
										</p>
									</td>
								</tr>
							</table>
