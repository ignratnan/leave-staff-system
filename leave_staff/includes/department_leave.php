...
<div class="main-container" style="background-color: #DCD7C9;">
	<div class="pd-ltr-20">
		...
		<?php
		$sql = "SELECT * from tbldepartments where id='$session_depart'";
					...
					<div class="col-md-6 col-sm-12">
						<nav aria-label="breadcrumb" role="navigation">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active" aria-current="page">Department Leave</li>
							</ol>
						</nav>
					</div>
			</div>
			...
			<div class="row pb-10 pl-3 pr-3">
				...
				<div class="col-xl-2 col-lg-3 col-md-6">
					<div class="card-box height-100-p widget-style3">
						<?php
						$sql = "SELECT leaveID from tblleaves join tblemployees on tblleaves.empID = tblemployees.empID where tblemployees.depID='$session_depart'";
				...
				<div class="col-xl-2 col-lg-3 col-md-6">
					<div class="card-box height-100-p widget-style3">
						<?php
						$sql = "SELECT leaveID from tblleaves join tblemployees on tblleaves.empID = tblemployees.empID where tblemployees.depID='$session_depart' and leaveStatus=1";
						$query = $dbh -> prepare($sql);
				...
				<div class="col-xl-2 col-lg-3 col-md-6">
					<div class="card-box height-100-p widget-style3">
						...
						$sql = "SELECT leaveID from tblleaves join tblemployees on tblleaves.empID = tblemployees.empID where tblemployees.depID='$session_depart' and leaveStatus=0";
						$query = $dbh -> prepare($sql);
				...
				<div class="col-xl-2 col-lg-3 col-md-6">
					<div class="card-box height-100-p widget-style3">
						<?php
						$sql = "SELECT leaveID from tblleaves join tblemployees on tblleaves.empID = tblemployees.empID where tblemployees.depID='$session_depart' and leaveStatus=2";
						$query = $dbh -> prepare($sql);
				...
				<div class="col-xl-2 col-lg-3 col-md-6">
					<div class="card-box height-100-p widget-style3">
						<?php
						$sql = "SELECT leaveID from tblleaves join tblemployees on tblleaves.empID = tblemployees.empID where tblemployees.depID='$session_depart' and leaveStatus=4";
						$query = $dbh -> prepare($sql);
							...
							<table class="table stripe hover nowrap">
								...
								<tbody>
									<tr>
										...
										$sql = "SELECT * from tblleaves join tblemployees on tblleaves.empID = tblemployees.empID where tblemployees.depID='$session_depart' order by leaveID desc";
							...
							<table class="table stripe hover nowrap">
								...
								<tbody>
									<tr>
										...
										$sql = "SELECT * from tblleaves join tblemployees on tblleaves.empID = tblemployees.empID where tblemployees.depID='$session_depart' and leaveStatus=1 order by leaveID desc";
											$query = mysqli_query($conn, $sql) or die(mysqli_error());
											while ($row = mysqli_fetch_array($query)) {
											  	$date = date('d-m-Y', strtotime($row['appliedDate']));
											  	$cnt=1;
							...
							<table class="table stripe hover nowrap">
								...
								<tbody>
									<tr>
										...
										$sql = "SELECT * from tblleaves join tblemployees on tblleaves.empID = tblemployees.empID where tblemployees.depID='$session_depart' and leaveStatus=0 order by leaveID desc";
											$query = mysqli_query($conn, $sql) or die(mysqli_error());
											while ($row = mysqli_fetch_array($query)) {
											  	$date = date('d-m-Y', strtotime($row['appliedDate']));
											  	$cnt=1;
							...
							<table class="table stripe hover nowrap">
								...
								<tbody>
									<tr>
										...
										$sql = "SELECT * from tblleaves join tblemployees on tblleaves.empID = tblemployees.empID where tblemployees.depID='$session_depart' and leaveStatus=2 order by leaveID desc";
											$query = mysqli_query($conn, $sql) or die(mysqli_error());
											while ($row = mysqli_fetch_array($query)) {
												$date = date('d-m-Y', strtotime($row['appliedDate']));
												$cnt=1;
							...
							<table class="table stripe hover nowrap">
								...
								<tbody>
									<tr>
										...
										$sql = "SELECT * from tblleaves join tblemployees on tblleaves.empID = tblemployees.empID where tblemployees.depID='$session_depart' and leaveStatus=4 order by leaveID desc";
											$query = mysqli_query($conn, $sql) or die(mysqli_error());
											while ($row = mysqli_fetch_array($query)) {
											  	$date = date('d-m-Y', strtotime($row['appliedDate']));
											  	$cnt=1;
