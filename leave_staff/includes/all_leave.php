	...
	<div class="pd-ltr-20">
		...
		<div class="p-2 pt-3 pb-3 mb-3" style="background-color: #F0F0F0;">
			...
			<div class="row pb-10 pl-3 pr-3">
				...
				<div class="col-xl-1 col-lg-3 col-md-6 mb-20"></div>
				...
				<div class="tab-pane fade show active" id="all" role="tabpanel">
					<div class="card-box" style="border-radius: 0px;">
						<div class="pb-20" style="min-height: 525px;">
							<table class="table stripe hover nowrap" id="myTable1">
								<thead>
									<tr>
										<!--@Search Fitur-->
										<div class="row">
											<div class="col-xl-12 col-lg-3 col-md-6 mb-1" style="text-align: right;">
												<input type="text" id="myInput1" onkeyup="myFunction1()" placeholder="Search.." class="pl-1 pr-1 pt-1 pb-1 m-1" style="border-width: 1px; width: 150px;">
											</div>
										</div>
										<!--#Search Fitur-->
									</tr>
								...
								<tbody>
									<tr>
										...
										$sql = "SELECT * from tblleaves join tblemployees on tblleaves.empID = tblemployees.empID order by leaveID desc";
			...
			<!--start approved leave-->
				<div class="tab-pane fade" id="approved" role="tabpanel">
					<div class="card-box" style="border-radius: 0px;">
						<div class="pb-20" style="min-height: 525px;">
							<table class="table stripe hover nowrap" id="myTable2">
								<thead>
									<tr>
										<!--@Search Fitur-->
										<div class="row">
											<div class="col-xl-12 col-lg-3 col-md-6 mb-1" style="text-align: right;">
												<input type="text" id="myInput2" onkeyup="myFunction2()" placeholder="Search.." class="pl-1 pr-1 pt-1 pb-1 m-1" style="border-width: 1px; width: 150px;">
											</div>
										</div>
										<!--#Search Fitur-->
									</tr>
								...
								<tbody>
									<tr>
										...
										$sql = "SELECT * from tblleaves join tblemployees on tblleaves.empID = tblemployees.empID where leaveStatus=1 order by leaveID desc";
											$query = mysqli_query($conn, $sql) or die(mysqli_error());
											while ($row = mysqli_fetch_array($query)) {
											  	$date = date('d-m-Y', strtotime($row['appliedDate']));
											  	$cnt=1;
			...
			<!--start pending leave-->
				<div class="tab-pane fade" id="pending" role="tabpanel">
					<div class="card-box" style="border-radius: 0px;">
						<div class="pb-20" style="min-height: 525px;">
							<table class="table stripe hover nowrap" id="myTable3">
								<thead>
									<tr>
										<!--@Search Fitur-->
										<div class="row">
											<div class="col-xl-12 col-lg-3 col-md-6 mb-1" style="text-align: right;">
												<input type="text" id="myInput3" onkeyup="myFunction3()" placeholder="Search.." class="pl-1 pr-1 pt-1 pb-1 m-1" style="border-width: 1px; width: 150px;">
											</div>
										</div>
										<!--#Search Fitur-->
									</tr>
								...
								<tbody>
									<tr>
										...
										$sql = "SELECT * from tblleaves join tblemployees on tblleaves.empID = tblemployees.empID where leaveStatus=0 order by leaveID desc";
											$query = mysqli_query($conn, $sql) or die(mysqli_error());
											while ($row = mysqli_fetch_array($query)) {
											  	$date = date('d-m-Y', strtotime($row['appliedDate']));
											  	$cnt=1;
			...
			<!--start rejected leave-->
				<div class="tab-pane fade" id="rejected" role="tabpanel">
					<div class="card-box" style="border-radius: 0px;">
						<div class="pb-20" style="min-height: 525px;">
							<table class="table stripe hover nowrap" id="myTable4">
								<thead>
									<tr>
										<!--@Search Fitur-->
										<div class="row">
											<div class="col-xl-12 col-lg-3 col-md-6 mb-1" style="text-align: right;">
												<input type="text" id="myInput4" onkeyup="myFunction4()" placeholder="Search.." class="pl-1 pr-1 pt-1 pb-1 m-1" style="border-width: 1px; width: 150px;">
											</div>
										</div>
										<!--#Search Fitur-->
									</tr>
								...
								<tbody>
									<tr>
										...
										$sql = "SELECT * from tblleaves join tblemployees on tblleaves.empID = tblemployees.empID where leaveStatus=2 order by leaveID desc";
											$query = mysqli_query($conn, $sql) or die(mysqli_error());
											while ($row = mysqli_fetch_array($query)) {
											  	$date = date('d-m-Y', strtotime($row['appliedDate']));
											  	$cnt=1;
			...
			<!--start expired leave-->
				<div class="tab-pane fade" id="expired" role="tabpanel">
					<div class="card-box" style="border-radius: 0px;">
						<div class="pb-20" style="min-height: 525px;">
							<table class="table stripe hover nowrap" id="myTable5">
								<thead>
									<tr>
										<!--@Search Fitur-->
										<div class="row">
											<div class="col-xl-12 col-lg-3 col-md-6 mb-1" style="text-align: right;">
												<input type="text" id="myInput5" onkeyup="myFunction5()" placeholder="Search.." class="pl-1 pr-1 pt-1 pb-1 m-1" style="border-width: 1px; width: 150px;">
											</div>
										</div>
										<!--#Search Fitur-->
									</tr>
								...
								<tbody>
									<tr>
										...
										$sql = "SELECT * from tblleaves join tblemployees on tblleaves.empID = tblemployees.empID where leaveStatus=4 order by leaveID desc";
											$query = mysqli_query($conn, $sql) or die(mysqli_error());
											while ($row = mysqli_fetch_array($query)) {
											  	$date = date('d-m-Y', strtotime($row['appliedDate']));
											  	$cnt=1;
