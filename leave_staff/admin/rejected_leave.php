					...
					<table class="data-table table stripe hover nowrap">
						...
						<tbody>
							<tr>
								...
								$GM_Status=2;
								$HR_Status=5;
								$sql = "SELECT tbl_leaves.id as lid,tblemployees.FirstName,tblemployees.LastName,tblemployees.location,tblemployees.emp_id,tbl_leaves.LeaveType,tbl_leaves.PostingDate,tbl_leaves.HOD_Status,tbl_leaves.HR_Status,tbl_leaves.GM_Status from tbl_leaves join tblemployees on tbl_leaves.empid=tblemployees.emp_id where (tbl_leaves.HOD_Status='$HOD_Status' or tbl_leaves.GM_Status='$GM_Status') and tbl_leaves.HR_Status = '$HR_Status' order by lid desc";
