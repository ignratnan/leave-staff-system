					...
					<table class="data-table table stripe hover nowrap">
						...
						<tbody>
							<tr>
								...
								<?php 
								$sql = "SELECT tbl_leaves.id as lid,tblemployees.FirstName,tblemployees.LastName,tblemployees.location,tblemployees.emp_id,tbl_leaves.LeaveType,tbl_leaves.PostingDate,tbl_leaves.HOD_Status, tbl_leaves.HR_Status, tbl_leaves.GM_Status from tbl_leaves join tblemployees on tbl_leaves.empid=tblemployees.emp_id order by lid desc";
