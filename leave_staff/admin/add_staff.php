...
<?php
	...
	<?php
        ...
        mysqli_query($conn,"INSERT INTO tblemployees(FirstName,LastName,EmailId,Password,Gender,Dob,Department,Address,Av_leave,role,Phonenumber,Status, location, Admin) VALUES('$fname','$lname','$email','$password','$gender','$dob','$department','$address','$leave_days','$department_role','$phonenumber','$status', 'NO-IMAGE-AVAILABLE.jpg', '$set_admin')         
		") or die(mysqli_error()); ?>
								...
								<div class="row">
									...
									<div class="col-md-4 col-sm-12">
										<div class="form-group">
											...
											<select name="department_role" class="custom-select form-control" required="true" autocomplete="off">
